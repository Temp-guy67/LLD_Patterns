...
package com.meetingroom.test;

import com.meetingroom.domain.*;
import com.meetingroom.facade.MeetingRoomReservationFacade;
...
public class MeetingRoomReservationTest {
    ...
    @BeforeEach
    void setUp() {
        // Note: In production, you'd want to reset the singleton or use dependency injection
        facade = MeetingRoomReservationFacade.getInstance();
    ...
    void testTimeSlotOverlap() {
        ...
        TimeSlot slot2 = new TimeSlot(baseTime.plusMinutes(30), baseTime.plusHours(1).plusMinutes(30));
    ...
    void testCreateEmployee() {
        ...
        Employee employee = facade.createEmployee(uniqueId, "John Doe", "john@company.com");
    ...
    void testCreateMeetingRoom() {
        ...
        MeetingRoom room = facade.createMeetingRoom(uniqueId, "Conference Room", 15, "Floor 2");
    ...
    void testFindRoomsByCapacity() {
        ...
        assertNotNull(rooms);
        rooms.forEach(room -> 
            assertTrue(room.getCapacity() >= 8, "All rooms should meet capacity requirement")
        );
    }
    ...
    void testActiveBookingsFilter() {
        ...
        Booking booking1 = facade.bookRoom("TEST_EMP1", "TEST_ROOM1", start, start.plusHours(1));
        Booking booking2 = facade.bookRoom("TEST_EMP1", "TEST_ROOM2", start, start.plusHours(1));
